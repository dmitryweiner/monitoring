...
не считаются. Если сдвинулось больше 10 % пикселей (порог пикселя 0.5σ),
...
Пороги проверены на суточной серии снимков 23–24 сентября: срабатывали
люди в кадре, лампа, рассвет и сумерки; плавная смена дневного света — нет.
